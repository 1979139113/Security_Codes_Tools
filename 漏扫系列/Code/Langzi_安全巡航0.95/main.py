...
Infon:{'url': 'http://www.langzi.fun', 'content': u'DOCTYPEhtml'xxxxx}
----------------
url:http://www.langzi.fun
content:
service:获取失败
    ...
    if '---' in result:
        if 'sqlmap was not able to fingerprint the back-end database management syste' not in result:
            try:
                ...
                results['report_0'] = inj.replace('Parameter: ','注入参数(方式) : ').replace('Type: ','注入方式 : ').replace('Title: ','注入标题 : ').replace('Payload: ','注入攻击 : ')
                if 'back-end DBMS' in dbs:
                    results['report_1'] = dbs.replace('the back-end DBMS is ','数据库类型 : ').replace('web server operating system: ','服务器版本 : ').replace('web application technology: ','服务器语言 : ').replace('back-end DBMS: ','数据库版本 : ')
                else:
...
def scan_sql(url,level=1):
    ...
    if link == None:
        ...
        if 'html_links' in link.keys():
            return scan_html(link['html_links'].replace(' ',''),link['title'],level)
...
weak_password = ['admin12345', 'admin123', 'asdfghjkl', 'mysql', '123456789qq', 'admin@123', 'q123456789', '12345', '7894561230', '123456789', 'zxc123', 'postgres', 'password123', 'asd123', '789456123', 'qwe123', '123', '9876543210', 'password', '123698745', '1q2w3e4r', '123123', 'w123456', '1233211234567', '7708801314520', '147258369', '123qwe', '1234', 'qwertyuiop', '1q2w3e', '123abc', 'qaz123456', '123456', 'zxcvbnm123', 'qazwsxedc', '0123456789', '1314520520', '1234554321', 'okmnji', '123456789a', 'admin123!@#', 'woaini1314', '1234567891234567', 'qwe123456', 'ubuntu', 'Sa1234', 'aa123456', '123465', '1234567899', '5201314', '1234567891', '1234567890', '123456abc', 'iloveyou', 'admin1234', 'abc123', '123456789.', 'Sa123', '1111111111', 'zxcvbnm', 'q123456', '0000000000000000', 'www123456', 'woaini123', '123qaz', '12345678910', '1234567', '0000000000', 'asd123456', 'abc123456', 'zxc123456', 'qq5201314', 'qq123456', '123456.', '1111111111111111', '0000', '88888888', '12345678', '12345678900', 'admin#123', '123123123', 'abc123456789', '123456q', 'abcd123456', 'qq123456789', 'woaini521', '123456a', 'Passw0rd', 'root', 'test123', 'abcd1234', '1357924680', '123456aa', 'abc12345', 'qwerty', 'woaini', '5201314520', '111111111', 'as123456', '1472583690', 'z123456', '123456789abc', '1qaz2wsx', 'test', '000000000', 'qazwsx', 'Sa123456', '123456qwerty', '987654321', '123456qq', '123456..', 'aaa123456', '135792468', 'w123456789', 'a123456789', '000000', 'woaini520', 'aini1314', 'q1w2e3r4', '111111', '123456789q', '110120119', 'oracle', 'a123456']
system_user_list=['root','ubuntu']

system_passwords_list=['admin12345', 'admin123', 'asdfghjkl', 'mysql', '123456789qq', 'admin@123', 'q123456789', '7894561230', '123456789', 'zxc123', 'postgres', 'password123', 'asd123', '789456123', 'qwe123', '123', '000000000', 'password', '123698745', '1q2w3e4r', '123123', 'w123456', '1233211234567', '7708801314520', '147258369', '123qwe', '1234', 'qwertyuiop', '1q2w3e', '123abc', 'qaz123456', 'root', '123456', 'zxcvbnm123', 'qazwsxedc', '0123456789', '1314520520', '1234554321', 'okmnji', '123456789a', 'admin123!@#', 'woaini1314', '1234567891234567', 'qwe123456', 'ubuntu', 'Sa1234', 'aa123456', '123465', '1234567899', '5201314', '1234567891', '1234567890', '123456abc', 'iloveyou', 'admin1234', 'abc123', '123456789.', 'Sa123', '1111111111', 'zxcvbnm', 'q123456', '0000000000000000', 'www123456', 'woaini123', '123qaz', '12345678910', '1234567', '0000000000', 'asd123456', 'abc123456', 'zxc123456', 'qq5201314', 'qq123456', '123456.', '1111111111111111', '0000', '88888888', '12345678', '12345678900', 'admin#123', '123123123', 'abc123456789', '123456q', 'abcd123456', 'qq123456789', '000000', '123456a', 'Passw0rd', '12345', 'test123', 'abcd1234', '1357924680', '123456aa', 'abc12345', 'qwerty', 'woaini', '5201314520', '111111111', 'as123456', '1472583690', 'z123456', '123456789abc', '1qaz2wsx', 'test', '9876543210', 'qazwsx', 'Sa123456', '123456qwerty', '987654321', '123456qq', '123456..', 'aaa123456', '135792468', 'w123456789', 'a123456789', 'woaini521', 'woaini520', 'aini1314', 'q1w2e3r4', '111111', '123456789q', '110120119', 'oracle', 'a123456']
...
def scan_ip(ip):
    ...
    try:
        ...
        if dbname:
            return 'Mongodb数据库未授权访问漏洞 : ' + str(ip) + ':27017'
    except Exception, e:
        pass
                    ...
                    for uuser in user_list:
                        for ppass in password_list:
                            ...
                            try:
                                r_br = requests.post(url=r_r, data=data, timeout=timeout)
                                if 'mainFrameset' in r_br.content:
                                    result.append('PHPmyadmin弱口令漏洞 : ' + str(r_r + ':' + str(str(uuser) + '|' + str(ppass))))
                            except Exception, e:
                                pass
            except Exception, e:
                pass

...
if __name__ == '__main__':
    ...
    urls = set(x.strip() for x in open(urls,'').readlines())
    url_ways = set(x.strip() for x in open(url_ways,'').readlines())
    usernames = set(x.strip() for x in open(usernames,'').readlines())
    passwords = set(x.strip() for x in open(passwords,'').readlines())

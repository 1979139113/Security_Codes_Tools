...
if __name__ == '__main__':
    a = Get_Info('http://www.hntky.com')
    res = a.scan_seo()
    print(res
          )
    '''
    {'百度权重': '4', '网站主页': 'http://www.hntky.com', '网站标题': '湖南铁路科技职业技术学院', 'IP__坐标': '获取失败', '所属__IP': '获取失败', '网站年龄': '14年1月24天（创建于2005年03月08日,过期时间为2027年03月08日)', '备案编号': '湘ICP备17021646号-1', '备案性质': '事业单位', '备案名称': '湖南铁路科技职业技术学院', '备案时间': '2018/12/27 0:00:00', '百度收录': '6120', '协议类型': '暂无信息', '页面类型': ' -  ', '服务类型': ' - ', '程序语言': ' - '}
    '''

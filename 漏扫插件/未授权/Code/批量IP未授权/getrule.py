...
def get_ip_vlun(ip):
    ...
    try:
        ...
        if dbname:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Mongodb数据库未授权访问漏洞 : ' + str(ip) + ':27017' + '\n')
    except Exception, e:
        pass
    ...
    try:
        ...
        if dbname:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Mongodb数据库未授权访问漏洞 : ' + str(ip) + ':27018' + '\n')
    except Exception, e:
        pass
    ...
    try:
        ...
        if "redis_version" in result:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Redis数据库未授权访问漏洞 : ' + str(ip) + ':6379' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    try:
        ...
        if "Authentication" in result:
            for pass_ in password_list:
                ...
                if '+OK' in result:
                    with open('result.txt', 'a+')as aaa:
                        aaa.write('Redis弱口令漏洞 : ' + str(ip) + ':6379|' + str(pass_) + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    ...
    try:
        ...
        if "zookeeper.version" in result:
            with open('result.txt', 'a+')as aaa:
                aaa.write('ZooKeeper未授权访问漏洞 : ' + str(ip) + ':2181' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    ...
    try:
        ...
        if resp.status == 200:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Elasticsearch未授权访问漏洞 : ' + str(ip) + ':9200' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    ...
    try:
        ...
        if "STAT version" in result:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Memcache未授权访问漏洞 : ' + str(ip) + ':11211' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
        ...
        try:
            ...
            if 'PUT' in data:
                ...
                if 'xxscan0' in res_html:
                    with open('result.txt', 'a+')as aaa:
                        aaa.write('IIS WebDav任意文件上传漏洞 : ' + str(url) + '\n')
        except Exception, e:
            pass
        finally:
            s.close()
                        ...
                        for ppass in password_list:
                            ...
                            try:
                                ...
                                if 'Router Configuration' in r_br.content:
                                    with open('result.txt', 'a+')as aaa:
                                        aaa.write('Tomcat远程部署弱口令漏洞 : ' + r_r + ':' + uuser + '|' + ppass + '\n')
                            except Exception, e:
                                pass
            except Exception, e:
                pass
        ...
        for r_r in r_:
            try:
                ...
                if 'arbitrary' in rxr.content:
                    with open('result.txt', 'a+')as aaa:
                        aaa.write('Jenkins未授权访问漏洞 : ' + str(r_r) + '\n')
            except Exception, e:
                pass
    except Exception, e:
        pass
    ...
    try:
        ...
        if 'root:' in data and 'nobody:' in data:
            with open('result.txt', 'a+')as aaa:
                aaa.write('WebServer任意文件读取漏洞 : ' + str(ip) + ':443' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    ...
    try:
        ...
        if 'root:' in data and 'nobody:' in data:
            with open('result.txt', 'a+')as aaa:
                aaa.write('WebServer任意文件读取漏洞 : ' + str(ip) + ':8080' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
    ...
    try:
        ...
        try:
            ...
            if ret.find(':root:') > 0:
                with open('result.txt', 'a+')as aaa:
                    aaa.write('Fast-Cgi文件读取漏洞 : ' + str(ip) + ':9000' + '\n')
        except Exception, e:
            pass
    except Exception, e:
        pass
                        ...
                        for ppass in password_list:
                            ...
                            try:
                                ...
                                if 'mainFrameset' in r_br.content:
                                    with open('result.txt', 'a+')as aaa:
                                        aaa.write('PHPmyadmin弱口令漏洞 : ' + str(r_r + ':' + str(str(uuser) + '|' + str(ppass))) + '\n')
                            except Exception, e:
                                pass
            except Exception, e:
                pass
    ...
    try:
        ...
        if 'Requested Range Not Satisfiable' in data and 'Server: Microsoft' in data:
            with open('result.txt', 'a+')as aaa:
                aaa.write('HTTP.sys远程代码执行漏洞 : ' + str(ip) + ':80' + '\n')
    except Exception, e:
        pass
    finally:
        s.close()
                ...
                if int(res_code) == 200 or int(res_code) == 500:
                    if k == 0:
                        ...
                        if (bgcode != necode) or (bglen != len(res_html)):
                            with open('result.txt', 'a+')as aaa:
                                aaa.write('.NET Padding Oracle信息泄露 : ' + str(url) + '\n')
    except Exception, e:
        pass
        ...
        for r_r in r_:
            try:
                ...
                if '/resin-doc/examples/index.xtp' in rxr.content:
                    with open('result.txt', 'a+')as aaa:
                        aaa.write('Resin viewfile远程文件读取漏洞 : ' + str(r_r) + '\n')
            except Exception, e:
                pass
    except Exception, e:
        pass
    ...
    try:
        ...
        if 'servlet/RequestParamExample' in rrrx.content:
            with open('result.txt', 'a+')as aaa:
                aaa.write('Tomcat example 应用信息泄漏漏洞:' + rrrx.url.strip('/') + '\n')
    except:
        pass
    ...
    try:
        ...
        if 'langzitest' in res.read():
            with open('result.txt', 'a+')as aaa:
                aaa.write('Jboss 认证绕过漏洞 : ' + str(webshell_url) + '\n')
    except Exception, e:
        pass
        ...
        for r_r in r_:
            try:
                ...
                if 'flavor=URL,type=DeploymentScanner' in rxr.content:
                    with open('result.txt', 'a+')as aaa:
                        aaa.write(r'JBoss后台上传漏洞 : ' + str(r_r) + '\n')
            except Exception, e:
                pass
    except Exception, e:
        pass
                ...
                for uuser in user_list:
                    for ppass in password_list:
                        ...
                        if 'WebLogic Server Console' in rxr.content:
                            with open('result.txt', 'a+')as aaa:
                                aaa.write('Weblogic弱口令漏洞 : ' + str(r_r + ':' + str(str(uuser) + '|' + str(ppass))) + '\n')
            except Exception, e:
                pass
    except Exception, e:
        pass
                        ...
                        for ppass in password_list:
                            ...
                            try:
                                ...
                                if 'Deployment' in r_br.content:
                                    with open('result.txt', 'a+')as aaa:
                                        aaa.write('JOnAS弱口令漏洞 : ' + str(r_r + ':' + str(str(uuser) + '|' + str(ppass))) + '\n')
                            except Exception, e:
                                pass
            except Exception, e:
                pass
    ...
    try:
        ...
        try:
            ...
            if len(p) > 0:
                with open('result.txt', 'a+')as aaa:
                    aaa.write('Weblogic CVE-2018-2628 : ' + str(ip) + ':7001' + '\n')
        except Exception, e:
            pass
    except Exception, e:
        pass
            ...
            for uuser in user_list:
                for ppass in password_list:
                    ...
                    for flag in flag_list:
                        if flag in res_html:
                            with open('result.txt', 'a+')as aaa:
                                aaa.write('Glassfish弱口令漏洞 : ' + str(xxixx + ':' + str(str(uuser) + '|' + str(ppass))) + '\n')
    except Exception, e:
        pass
            ...
            for ppass in password_list:
                try:
                    ...
                    for flag in flag_list:
                        if flag in res_html:
                            with open('result.txt', 'a+')as aaa:
                                aaa.write('Wordpress弱口令漏洞 : ' + str(request.url + ':' + uuser + '|' + ppass) + '\n')
                except Exception, e:
                    pass
    ...
    try:
        ...
        if m.group(1):
            ...
            if 'axisconfig' in res_html:
                with open('result.txt', 'a+')as aaa:
                    aaa.write('Axis2任意文件读取漏洞 : ' + str(read_url) + '\n')
    except Exception, e:
        pass
                        ...
                        for ppass in password_list:
                            ...
                            try:
                                ...
                                if 'Upload Service' in r_br.content:
                                    with open('result.txt', 'a+')as aaa:
                                        aaa.write('Axis2弱口令漏洞 : ' + str(r_r + ':' + str(str(uuser) + '|' + str(ppass))) + '\n')
                            except Exception, e:
                                pass
            except Exception, e:
                pass

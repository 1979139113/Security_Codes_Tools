...
st = ['VloginUser.action', 'Mail.action', 'code.action', 'reg.action', 'Address.action', '!Index.action',
      'login.action', 'Add.action', 'pageslist.action', '.Action', 'Message.action', 'getMul.action', 'shouye.action',
      'logout.action', 'Valid.action', 'search.action', 'Magazine.action', 'news.action', 'init.action',
      'create.action', 'index2.action', 'default.action', 'welcome.action', 'Name.action', 'single.action',
      'updateForm.action', 'SysStart.action', 'adminlogin.action', 'Offportal.action', 'Buying.action',
      'Success.action', 'exchange.action', 'menu.action', 'airport.action', 'Email.action', 'On.action', 'show.action',
      'tain.action', 'randomPicture.action', 'news.do']
...
# 671 条
body_rule = [
'/robots.txt|EmpireCMS|EmpireCMS',
'/images/css.css.lnk|KesionCMS(科讯)|kesioncms',
'/data/flashdata/default/cycle_image.xml|ecshop|ecshop',
'/admin/SouthidcEditor/Include/Editor.js|良精|southidc',
'/plugin/qqconnect/bind.html|PHP168(国徽)|php168',
'/SiteServer/Themes/Language/en.xml|SiteServer|siteserver',
'/system/images/fun.js|KingCMS|kingcms',
'/INSTALL.mysql.txt|Drupal(水滴)|drupal',
'/themes/default/style.css|ecshop|ECSHOP',
...
'/Ch/Memberphoto.Asp|liangjing(良精)|liangjing',
'/admin/template/foot.htm|qiboSoft(齐博)|qiboSoft',
'/Data/sitemap_cache.xml|Dvbbs(动网)|dvbbs',
'/zb_users/THEME/HTML5CSS3/theme.xml|Z-Blog|z-blog',
'/hack/cnzz/template/ask.htm|qiboSoft(齐博)|qiboSoft',
'/API/Request.xml|PowerEasy(动易)|powereasy',
'/counter.asp|KingCMS|kingcms',
'/feedback/core.class.php|KingCMS|kingcms',
'/admin/templates/about_us.htm|ecshop|ecshop',
'/wind/http/mime/mime|PHPWind|phpwind',
'/example.gitignore|Drupal(水滴)|drupal',
'/install.php|KingCMS|kingcms',
'/LICENSE|PHPWind|phpwind',
'/ads/install/templates/ads-float.html|phpCMS(盛大)|phpcms',
'/Asp/ImageList.Asp|Southidc(南方数据)|southidc',
'/media/com_joomlaupdate/default.js|Joomla(逐浪)|joomla',
'/Controls/Company/Company.ascx|PowerEasy(动易)|powereasy',
'/JS/checklogin.js|PowerEasy|powereasy',
'/api/manyou/cloud_channel.htm|Discuz(康盛)|discuz',
'/e/data/ecmseditor/images/blank.html|EmpireCMS(帝国)|empirecms',
'/RSS.xsl|PowerEasy(动易)|powereasy',
'/phpsso_server/statics/js/formvalidator.js|phpcms|PHPCMS',
'/Templets/about/index.htm|FoosunCMS(风讯)|foosuncms',
'/Templets/pro/cms.htm|FoosunCMS(风讯)|foosuncms',
'/admin/imgs/starno.gif|maxcms|c758dea036133e583d03145d721bcf75|',
'/.editorconfig|Drupal(水滴)|drupal',
'/admin/left.htm|Dvbbs(动网)|dvbbs',
'/e/admin/ecmseditor/infoeditor/epage/images/blank.html|EmpireCMS(帝国)|empirecms',
'/Enrss.xml|liangjing(良精)|liangjing',
'/admin/template/sort/editsort.htm|qiboSoft(齐博)|qiboSoft',
'/content/cache/options|Emlog|emlog',
'/data/js/config.js|phpCMS|phpcms',
'/robots.txt|SiteServer|siteserver',
'/Ads/left.js|Southidc|southidc',
'/fckeditor/fckconfig.js|AspCMS|aspcms',
'/special/type/dev.html|phpCMS(盛大)|phpcms',
'/uc_server/view/default/admin_frame_main.htm|Discuz|http://www.Discuz.com',
'/module/info/include/mysql/phpcms_info.sql|phpCMS(盛大)|phpcms',
'/robots.txt|HdWiki|hdwiki',
'/Admin/Common/HelpLinks.xml|PowerEasy|powereasy',
'/admin/template/label/maketpl/1.htm|qibosoft|qiboSoft',
'/Css/cndw/pub_cndw.css|Dvbbs(动网)|dvbbs',
'/wind.sql|PHPWind|phpwind',
'/wenba/install/mysql.sql|phpCMS(盛大)|phpcms',
'/Css/green/pub_cndw_green.css|Dvbbs(动网)|dvbbs',
'/Skin/OceanStar/user/default.css|PowerEasy(动易)|powereasy',
'/Html_skin30/downclass_29_1.html|LjCMS(良精)|ljcms',
'/admin/templates/about_us.htm|Ecshop(商派)|ecshop',
'/installation/template/js/installation.js|Joomla(逐浪)|joomla',
'/admin/webftp/index.asp|KingCMS|kingcms',
'/js/transport.js|Ecshop(商派)|ecshop',
'/phpunit.xml.dist|joomla|joomla',
...
'/Template/Default/Skin/user/default.css|PowerEasy|powereasy',
'/licence.txt|PHPWind|phpwind',
'/down/index.html|FoosunCMS|foosuncms',
'/page/webftp/fun.asp|KingCMS|kingcms',
'/scripts/test.script|Drupal(水滴)|drupal',
'/robots.txt.dist|Joomla(逐浪)|joomla',
'/readme.html|WordPress|wordpress',
'/themes/Blueocean/exchange_goods.dwt|Ecshop(商派)|ecshop',
'/SiteFiles/bairong/SqlScripts/cms.sql|SiteServer|siteserver',
'/CHANGELOG.txt|Drupal(水滴)|drupal',
'/readme.htm|WordPress|wordpress',
'/view/default/admin_addlink.htm|HdWiki|hdwiki',
...
'/installation/language/zh-CN/zh-CN.ini|Joomla(逐浪)|joomla',
'/js/api.js|HdWiki(中文维基)|hdwiki',
'/api/agent.html|PHPWind|phpwind',
'/data/textdata/index.html|DedeCMS(织梦)|dedecms',
'/dede/templets/article_coonepage_rule.htm|dedecms|dedecms',
'/htaccess.txt|Joomla(逐浪)|joomla',
'/Foosun/Admin/Mall/Mall_Factory.Asp|FoosunCMS(风讯)|foosuncms',
'/Script/Html.js|Southidc(南方数据)|southidc',
'/system/js/jquery.kc.js|KingCMS|kingcms',
'/admin/Article/index.asp|KingCMS|kingcms',
'/inc/Admin_transformxhml.xslt|Dvbbs(动网)|dvbbs',
'/|Discuz!|Powered by.*?</a></strong>',
'/d/js/vote/index.html|EmpireCMS(帝国)|empirecms',
'/phpwind/lang/wind/admin/admin.htm|PHPWind|phpwind',
'/newsfader.js|Discuz(康盛)|discuz',
'/search.html|FoosunCMS(风讯)|foosuncms',
'/Language/Gb2312.xml|PowerEasy|powereasy',
'/connexion/template/custom_weibo_template.htm|PHPWind|phpwind',
'/alipay.html|Ecshop(商派)|ecshop',
'/order/install/templates/deliver.html|phpCMS(盛大)|phpcms',
'/readme.txt|WordPress|wordpress',
'/License.txt|PowerEasy(动易)|powereasy',
'/profiles/README.txt|Drupal(水滴)|drupal',
...
'/Admin/Collect/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/webftp/index.asp|KingCMS|kingcms',
'/Article/index.asp|KingCMS|kingcms',
'/install/data/data_en_us.sql|Ecshop(商派)|ecshop',
'/themes/default/library/member.lbi|ecshop|ECSHOP',
'/e/data/template/gbooktemp.txt|empirecms|empirecms',
'/Temp/ajaxnote.txt|PowerEasy(动易)|powereasy',
'/Template/Default/Skin/user/default.css|PowerEasy(动易)|powereasy',
'/ckeditor/plugins/gallery/plugin.js|PHP168(国徽)|php168',
'/|liangjing(良精)|liangjing',
'/dede/action/css_body.css|DedeCMS(织梦)|dedecms',
...
'/admin/template/cutimg/cutimg.htm|qibosoft|qiboSoft',
'/house/.htaccess|phpCMS(盛大)|phpcms',
'/EasyArticle/index.asp|KingCMS|kingcms',
'/data/index.html|DedeCMS(织梦)|dedecms',
'/zb_system/DEFEND/thanks.html|Z-Blog|z-blog',
'/wind/readme|PHPWind|phpwind',
'/adminsoft/include/admin_language_cn.php|EspCMS(易思)|espcms',
'/admin/help/zh_cn/database.xml|ecshop|ecshop',
'/alipay.html|ecshop|ecshop',
'/skin/admin/style.css|PHP168|php168',
'/readme.txt|PHP168(国徽)|php168',
...
'/style/default/admin/admin.css|HdWiki(中文维基)|hdwiki',
'/install/js/transport.js|Ecshop(商派)|ecshop',
'/Resource/Classical/boardhelp_html4.htm|Dvbbs(动网)|dvbbs',
'/formguide/install/templates/form_index.html|phpCMS|phpcms',
'/public/class_dbmysql.php|EspCMS(易思)|espcms',
'/robots.txt|Discuz(康盛)|discuz',
'/install/data/empiredown.com.sql|EmpireCMS(帝国)|empirecms',
'/content/templates/default/main.css|Emlog|emlog',
'/license.txt|EspCMS(易思)|espcms',
'/PLUGIN/ThemeSapper/plugin.xml|Z-Blog|z-blog',
'/SiteServer/Services/AdministratorService.asmx|SiteServer|siteserver',
'/data/cycle_image.xml|ecshop|ecshop',
'/e/tool/feedback/temp/test.txt|empirecms|empirecms',
'/Template/Default/Skin/default.css|PowerEasy(动易)|powereasy',
'/|ThinkPHP|thinkphp',
'/admin/template/module/make.htm|qiboSoft(齐博)|qiboSoft',
'/sites/all/themes/README.txt|Drupal(水滴)|drupal',
'/login.asp|KingCMS|kingcms',
'/INSTALL.pgsql.txt|Drupal(水滴)|drupal',
'/message/install/mysql.sql|phpCMS(盛大)|phpcms',
'/Skin/OceanStar/default.css|PowerEasy|powereasy',
'/Admin/Include/version.xml|KesionCMS(科讯)|kesioncms',
'/UserCenter/Inc/script.js|SiteServer|siteserver',
'/special/index.html|DedeCMS(织梦)|dedecms',
'/wp-admin/css/colors-classic.css|WordPress|wordpress',
'/SiteServer/UserCenter/Skins/Skin-Footer.ascx|SiteServer|siteserver',
'/view/default/admin_addlink.htm|HdWiki(中文维基)|hdwiki',
'/content/cache/blogger|Emlog|emlog',
'/core/vendor/README.txt|Drupal(水滴)|drupal',
'/install/data/demo/zh_cn.sql|Ecshop(商派)|ecshop',
'/Dv_plus/myspace/drag/space.js|Dvbbs(动网)|dvbbs',
'/Map/51ditu/Index.Asp|Southidc(南方数据)|southidc',
'/admin/template/mysql/into.htm|qiboSoft(齐博)|qiboSoft',
'/En/Index.Asp|LjCMS(良精)|ljcms',
'/Resource/Format_Fuc.xslt|Dvbbs(动网)|dvbbs',
'/images/dialog.css|PHP168(国徽)|php168',
'/demo/js/check.js|Ecshop(商派)|ecshop',
'/yp/images/js/global.js|phpCMS(盛大)|phpcms',
...
'/template/special/showsp2.htm|qiboSoft(齐博)|qiboSoft',
'/MAINTAINERS|Drupal(水滴)|drupal',
'/Ads/left.js|Southidc(南方数据)|southidc',
'/admin/template/html/set.htm|qiboSoft(齐博)|qiboSoft',
'/phpsso_server/statics/js/formvalidator.js|phpCMS(盛大)|phpcms',
'/images/post/DhtmlEdit.js|Dvbbs(动网)|dvbbs',
'/zb_users/PLUGIN/FileManage/plugin.xml|Z-Blog|z-blog',
'/wp-content/themes/twentyeleven/readme.txt|WordPress|wordpress',
'/admin/Inc/southidc.css|良精|southidc',
'/phpunit.xml.dist|Joomla(逐浪)|joomla',
'/|IMGCms|Powered by IMGCMS',
'/bbcode.js|Discuz(康盛)|discuz',
'/dv_edit/main.js|Dvbbs(动网)|dvbbs',
'/Skin/OceanStar/default.css|PowerEasy(动易)|powereasy',
'/e/data/fc/index.html|empirecms|empirecms',
'/humans.txt|PHPWind|phpwind',
'/install/templates/license_en_us.htm|ecshop|ECShop',
'/Add.ASP|Southidc(南方数据)|southidc',
'/wp-content/themes/twentyten/style.css|WordPress|wordpress',
'/Css/gray/style.css|Dvbbs(动网)|dvbbs',
'/src/extensions/demo/Manifest.xml|PHPWind|phpwind',
'/Database/SiteWeaver.sql|PowerEasy(动易)|powereasy',
'/xml/xml.xsl|PowerEasy(动易)|powereasy',
'/adminsoft/control/connected.php|EspCMS(易思)|espcms',
'/templets/default/style/dedecms.css|dedecms|DedeCMS',
'/comment/include/js/comment.js|phpCMS(盛大)|phpcms',
'/down/index.html|FoosunCMS(风讯)|foosuncms',
'/Web.config|LjCMS(良精)|ljcms',
'/Template/Default/Skin/default.css|PowerEasy|powereasy',
'/media/editors/tinymce/templates/template_list.js|Joomla(逐浪)|joomla',
'/images/manage/admin.js|Dvbbs(动网)|dvbbs',
'/ewebeditor/KindEditor.js|PHP168|php168',
'/modules/user/user.info|Drupal(水滴)|drupal',
'/admin/template/fu_sort/editsort.htm|qiboSoft(齐博)|qiboSoft',
'/recommend.html|PHPWind|phpwind',
'/d/file/index.html|EmpireCMS(帝国)|empirecms',
'/czfy/template/index.html|KesionCMS(科讯)|kesioncms',
'/content/cache/links|Emlog|emlog',
'/install/cms_index.html|phpCMS|phpcms',
'/adminsoft/js/control.js|EspCMS(易思)|espcms',
'/admin/views/style/default/style.css|Emlog|emlog',
'/admin/js/validator.js|Ecshop(商派)|ecshop',
'/Css/Style.css|Southidc(南方数据)|southidc',
...
'/data/admin/allowurl.txt|DedeCMS(织梦)|dedecms',
'/ckeditor/plugins/gallery/plugin.js|PHP168|php168',
'/js/util.js|PHP168|php168',
'/SiteServer/Installer/EULA.html|SiteServer|siteserver',
'/|ThinkPHP|think_template',
'/THEMES/default/TEMPLATE/catalog.html|Z-Blog|z-blog',
'/Admin/Images/southidc.css|Southidc(南方数据)|southidc',
'/Css/red/style.css|Dvbbs(动网)|dvbbs',
'/Users/All_User.Asp|FoosunCMS(风讯)|foosuncms',
'/ewebeditor/KindEditor.js|PHP168(国徽)|php168',
'/wap/Language/Gb2312.xml|PowerEasy(动易)|powereasy',
'/admin/template/center/config.htm|qiboSoft(齐博)|qiboSoft',
'/JS/checklogin.js|PowerEasy(动易)|powereasy',
'/zb_users/CACHE/updateinfo.txt|Z-Blog|z-blog',
'/|Discuz!|Powered by.*?<',
'/uc_server/view/default/admin_frame_main.htm|Discuz(康盛)|discuz',
'/Admin/Collect/vssver2.scc|FoosunCMS|foosuncms',
'/|科蚁CMS|keyicms：keyicms',
'/themes/tests/README.txt|Drupal(水滴)|drupal',
'/vote/install/templates/index.html|phpCMS(盛大)|phpcms',
'/User/Accessories/AvatarUploadHandler.ashx|PowerEasy(动易)|powereasy',
'/phpcms/templates/default/wap/header.html|phpCMS(盛大)|phpcms',
'/data/cycle_image.xml|Ecshop(商派)|ecshop',
'/member/include/js/login.js|phpCMS(盛大)|phpcms',
'/admin/Inc/southidc.css|Southidc(南方数据)|southidc',
'/Tools/index.asp|KingCMS|kingcms',
'/m/template/footer.htm|PHPWind|phpwind',
'/cms/install/index.html|PHP168|php168',
'/plugins/mwimport/desc.xml|HdWiki|hdwiki',
'/t/index.html|EmpireCMS(帝国)|empirecms',
'/.gitattributes|Drupal(水滴)|drupal',
'/CONTRIBUTING.md|Joomla(逐浪)|joomla',
'/Plus_popwan/CacheFile/sn.config|Dvbbs(动网)|dvbbs',
'/Skins/aspsky_1.css|Dvbbs(动网)|dvbbs',
'/JS/12.js|KesionCMS(科讯)|kesioncms',
'/wp-content/plugins/akismet/akismet.js|WordPress|wordpress',
'/media/jui/css/chosen.css|Joomla(逐浪)|joomla',
'/template/default/common/common.css|Discuz(康盛)|discuz',
'/Master/default.Master|LjCMS(良精)|ljcms',
'/admin/_Style/_notes/dwsync.xml|AspCMS|aspcms',
'/Install/Demo/Demo.sql|PowerEasy(动易)|powereasy',
'/template/common/activecode.html|KesionCMS(科讯)|kesioncms',
'/boke/Script/Dv_form.js|Dvbbs(动网)|dvbbs',
'/e/extend/index.html|EmpireCMS(帝国)|empirecms',
'/admin/template/cutimg/cutimg.htm|qiboSoft(齐博)|qiboSoft',
'/media/jui/css/chosen.css|joomla|joomla',
'/Global.asax|LjCMS(良精)|ljcms',
'/include/alert.htm|DedeCMS(织梦)|dedecms',
'/ad.asp|KingCMS|kingcms',
'/COPYRIGHT.txt|Drupal(水滴)|drupal',
'/wp-includes/wlwmanifest.xml|WordPress|WordPress',
'/template/admin/ask/config.html|PHP168|php168',
'/Editor/Lable/PE_Annouce.htm|PowerEasy(动易)|powereasy',
'/admin/template/center/config.htm|qibosoft|qiboSoft',
'/esf/template/index.html|KesionCMS(科讯)|kesioncms',
'/Editor/Lable/PE_Annouce.htm|PowerEasy|powereasy',
'/Admin/images/admin.js|Dvbbs(动网)|dvbbs',
'/KS_Inc/ajax.js|KesionCMS(科讯)|kesioncms',
...
'/Language/Gb2312.xml|PowerEasy(动易)|powereasy',
'/template/default/common/common.css|Discuz|Discuz! X',
'/user/index.php|KingCMS|kingcms',
'/Dv_plus/myspace/script/fuc_setting.xslt|Dvbbs(动网)|dvbbs',
'/form/install/data.sql|PHP168(国徽)|php168',
'/mobile/templates/article.html|ecshop|ECSHOP',
'/INSTALL|Drupal(水滴)|drupal',
'/js/editor/editor.js|HdWiki(中文维基)|hdwiki',
'/User/PopCalendar.js|PowerEasy(动易)|powereasy',
'/License.txt|PowerEasy|powereasy',
'/admin/template/article_more/config.htm|qiboSoft|qiboSoft',
'/admin.asp|KingCMS|kingcms',
'/SCRIPT/common.js|Z-Blog|z-blog',
'/mspace/default1/style.ini|Discuz(康盛)|discuz',
...
'/Resource/Admin/pub_html1.htm|Dvbbs(动网)|dvbbs',
'/Images/ad.js|Southidc|southidc',
'/templates.cdb|Discuz(康盛)|discuz',
'/robots.txt|WordPress|Allow: /wp-admin/admin-ajax.php',
'/style/aoyun/hdwiki.css|HdWiki(中文维基)|hdwiki',
'/d/js/class/index.html|EmpireCMS(帝国)|empirecms',
'/readme.txt|PHP168|php168',
'/hack/upgrade/template/get.htm|qiboSoft(齐博)|qiboSoft',
'/inc/Templates/bbsinfo.xml|Dvbbs(动网)|dvbbs',
'/|易普拉格科研管理系统|lan12-jingbian-hong',
'/Space/Template/sealove/index.xsl|PowerEasy(动易)|powereasy',
'/source/plugin/myapp/discuz_plugin_myapp.xml|Discuz(康盛)|discuz',
'/d/file/p/index.html|EmpireCMS(帝国)|empirecms',
'/zb_system/DEFEND/default/footer.html|Z-Blog|z-blog',
'/help.txt|WordPress|wordpress',
'/widget/blog_sohu.xhtml|ecshop|ECSHOP',
'/install/templates/step.html|EspCMS(易思)|espcms',
'/boke/Skins/dvskin/xml/index.xslt|Dvbbs(动网)|dvbbs',
'/themes/README.txt|Drupal(水滴)|drupal',
'/admin/views/default/main.css|Emlog|emlog',
'/skin/admin/style.css|PHP168(国徽)|php168',
'/template/default/cutimg.htm|qiboSoft(齐博)|qiboSoft',
'/Dv_plus/IndivGroup/Skin/Dispbbs.xslt|Dvbbs(动网)|dvbbs',
'/Ch/Index.Asp|LjCMS(良精)|ljcms',
'/Html_skin30/enabout.html|liangjing(良精)|liangjing',
'/UPGRADE.txt|Drupal(水滴)|drupal',
'/apps/groups/template/m_header.htm|PHPWind|phpwind',
'/a_d/install/data.sql|qiboSoft(齐博)|qiboSoft',
'/apps/stopic/template/stopic.htm|PHPWind|phpwind',
'/sites/all/README.txt|Drupal(水滴)|drupal',
'/template/default.htm|KingCMS|kingcms',
'/en/Module/AboutDetail.ascx|LjCMS(良精)|ljcms',
'/source/plugin/myapp/discuz_plugin_myapp.xml|Discuz|Discuz! Plugin',
'/mood/install/templates/header.html|phpCMS(盛大)|phpcms',
'/form/admin/template/label/form.htm|qiboSoft(齐博)|qiboSoft',
'/js/api.js|HdWiki|hdwiki',
'/Web.config|PowerEasy(动易)|powereasy',
'/guestbook/install/templates/index.html|phpCMS(盛大)|phpcms',
'/Admin/MasterPage/Default.Master|LjCMS(良精)|ljcms',
'/page/Tools/fun.asp|KingCMS|kingcms',
'/Admin/PublicSite/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/wap/Language/Gb2312.xml|PowerEasy|powereasy',
'/user.asp|KingCMS|kingcms',
'/language/en-GB/en-GB.com_contact.ini|joomla|joomla',
'/wp-includes/css/buttons.css|WordPress|wordpress',
'/Qq/xml/qq.xml|Southidc|southidc',
'/libraries/joomla/filesystem/meta/language/en-GB/en-GB.lib_joomla_filesystem_patcher.ini|Joomla(逐浪)|joomla',
'/Controls/AttachFieldControl.ascx|PowerEasy(动易)|powereasy',
'/download/index.asp|KingCMS|kingcms',
'/member/template/default/homepage.htm|qiboSoft(齐博)|qiboSoft',
'/web.config.txt|joomla|joomla',
'/e/data/fc/index.html|EmpireCMS(帝国)|empirecms',
'/demo/templates/faq_en_us_utf-8.htm|ecshop|ECSHOP',
'/robots.txt|HdWiki(中文维基)|hdwiki',
'/union/install/mysql.sql|phpCMS(盛大)|phpcms',
'/error_report/install/mysql.sql|phpCMS(盛大)|phpcms',
'/hack/cnzz/template/menu.htm|PHP168(国徽)|php168',
'/menu.asp|KingCMS|kingcms',
'/INSTALL.php|KingCMS|kingcms',
'/admin/ecshopfiles.md5|Ecshop(商派)|ecshop',
'/robots.txt|EmpireCMS(帝国)|empirecms',
'/Admin/JS/AdminIndex.js|PowerEasy(动易)|powereasy',
...
'/template/default/cutimg.htm|qibosoft|qiboSoft',
'/admin/help/zh_cn/database.xml|Ecshop(商派)|ecshop',
'/install/|qiboSoft(齐博)|qiboSoft',
'/rss.xsl|PowerEasy(动易)|powereasy',
'/libraries/joomla/html/language/en-GB/en-GB.jhtmldate.ini|Joomla(逐浪)|joomla',
'/api/alipay.php|KingCMS|kingcms',
'/s/index.html|EmpireCMS(帝国)|empirecms',
'/plugins/mwimport/desc.xml|HdWiki(中文维基)|hdwiki',
'/aCloud/index.html|PHPWind|phpwind',
'/e/data/ecmseditor/images/blank.html|empirecms|empirecms',
'/admin/index.htm|phpCMS(盛大)|phpcms',
'/robots.txt|phpCMS(盛大)|phpcms',
'/video/install/templates/category.html|phpCMS(盛大)|phpcms',
...
'/admin/discuzfiles.md5|Discuz(康盛)|discuz',
'/templates/wap/en/public/footer.html|EspCMS(易思)|espcms',
...
'/Config/AjaxHandler.config|PowerEasy(动易)|powereasy',
'/API/api.config|KesionCMS(科讯)|kesioncms',
'/Config/filtersearch/s3.xml|KesionCMS(科讯)|kesioncms',
'/e/data/template/gbooktemp.txt|EmpireCMS(帝国)|empirecms',
'/Admin/Common/HelpLinks.xml|PowerEasy(动易)|powereasy',
'/style/default/desc.xml|HdWiki(中文维基)|hdwiki',
'/setup/license.html|DedeCMS(织梦)|dedecms',
'/apps/weibo/template/m_weibo_bottom.htm|PHPWind|phpwind',
'/link/install/templates/index.html|phpCMS|phpcms',
'/|JBOSS|JBoss',
'/admin/views/style/green/style.css|Emlog|emlog',
'/images/style.css|KingCMS|kingcms',
'/js/jqeditor/hdwiki.js|HdWiki|hdwiki',
'/d/js/acmsd/index.html|EmpireCMS(帝国)|empirecms',
'/plugins/manyou/discuz_plugin_manyou.xml|Discuz(康盛)|discuz',
'/|大米CMS|content="大米CMS',
'/member/images/base.css|DedeCMS(织梦)|dedecms',
'/robots.txt|MLECMS|mlecms',
'/|Apache Tomcat|Apache Tomcat/7.0.52',
'/install/dbmysql/db.sql|EspCMS(易思)|espcms',
'/d/js/pic/index.html|EmpireCMS(帝国)|empirecms',
'/THEMES/default/theme.xml|Z-Blog|z-blog',
'/mail/install/templates/sendmail.html|phpCMS(盛大)|phpcms',
'/install/|qiboSoft|qiboSoft',
'/Admin/FreeLabel/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/themes/default_old/library/comments.lbi|Ecshop(商派)|ecshop',
'/Tags.html|FoosunCMS(风讯)|foosuncms',
'/space/images/js/space.js|phpCMS|phpcms',
'/wap/template/foot.htm|qiboSoft(齐博)|qiboSoft',
'/Module/AboutDetail.ascx|LjCMS(良精)|ljcms',
'/PLUGIN/PingTool/plugin.xml|Z-Blog|z-blog',
'/data/mytag/index.html|DedeCMS(织梦)|dedecms',
'/|蝉知CMS|Set-Cookie: frontsid',
'/skins/classical.css|Dvbbs(动网)|dvbbs',
'/installation/language/en-GB/en-GB.ini|Joomla(逐浪)|joomla',
'/Users/Mall/OrderPrint.Asp|FoosunCMS(风讯)|foosuncms',
'/hack/app/info.xml|PHPWind|phpwind',
'/ad/index.asp|KingCMS|kingcms',
'/static/js/admincp.js|Discuz|Discuz',
...
'/template/common/activecode.html|kesioncms|kesioncms',
'/Script/Html.js|Southidc|southidc',
'/main.asp|KingCMS|kingcms',
'/WebServices/CategoryService.asmx|PowerEasy(动易)|powereasy',
'/install/cms_index.html|phpCMS(盛大)|phpcms',
'/templates/default/info/area.html|phpCMS|phpcms',
'/data/sessions/index.html|DedeCMS(织梦)|dedecms',
'/Css/aqua/style.css|Dvbbs(动网)|dvbbs',
'/data/lang/zh_cn.js|PHPWind|PHPWind',
'/style/default/admin/admin.css|HdWiki|hdwiki',
'/mobile/templates/article.html|Ecshop(商派)|ecshop',
'/statics/js/cookie.js|phpCMS(盛大)|phpcms',
'/Space/js/ks.space.page.js|KesionCMS(科讯)|kesioncms',
'/plugins/hdapi/view/admin_hdapi.htm|HdWiki|hdwiki',
'/sites/README.txt|Drupal(水滴)|drupal',
'/digg/install/templates/index.html|phpCMS(盛大)|phpcms',
'/robots.txt|phpcms|PHPCMS',
'/install/dbmysql/demodb.sql|EspCMS(易思)|espcms',
'/joomla.xml|Joomla(逐浪)|joomla',
'/User/contr/lib/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/wlwmanifest.xml|Emlog|emlog',
'themes/default_old/activity.dwt|ecshop|ecshop',
'/T/skin05/about.html|LjCMS(良精)|ljcms',
'/phpcms/templates/default/member/connect.html|phpCMS(盛大)|phpcms',
'/u/themes/default/footer.htm|PHPWind|phpwind',
'/Css/Style.css|Southidc|southidc',
'/member/template/blue/foot.htm|qiboSoft(齐博)|qiboSoft',
'/space/images/js/space.js|phpCMS(盛大)|phpcms',
'/|EspCMS(易思)|espcms',
'/apply/_notes/dwsync.xml|AspCMS|aspcms',
'/modules/README.txt|Drupal(水滴)|drupal',
'/data/flashdata/default/cycle_image.xml|Ecshop(商派)|ecshop',
'/search/install/templates/index.html|phpCMS(盛大)|phpcms',
'/|313自助建站|313CMS',
'/license.txt|WordPress|wordpress',
'/company/template/default/search_list.htm|DedeCMS(织梦)|dedecms',
'/Inc/NoSqlHack.Asp|Southidc(南方数据)|southidc',
'/php/modpage/readme.txt|DedeCMS(织梦)|dedecms',
'/admin/template/fu_sort/editsort.htm|qibosoft|qiboSoft',
'/phpwind/licence.txt|PHPWind|phpwind',
'/README.txt|Joomla(逐浪)|joomla',
'/wp-includes/js/tinymce/wp-tinymce.js|WordPress|wordpress',
'/MAINTAINERS.txt|Drupal(水滴)|drupal',
'/plug/comment.html|AspCMS|aspcms',
'/Admin/News/lib/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/wap/templates/article.wml|Ecshop(商派)|ecshop',
'/apps/diary/template/m_diary_bottom.htm|PHPWind|phpwind',
'/Index.html|FoosunCMS(风讯)|foosuncms',
'/T/skin01/enindex.html|LjCMS(良精)|ljcms',
'/member/js/box.js|DedeCMS(织梦)|dedecms',
'/INSTALL.asp|KingCMS|kingcms',
'/admin/template/blend/set.htm|qiboSoft(齐博)|qiboSoft',
'/administrator/components/com_login/login.xml|Joomla(逐浪)|joomla',
'/data/js/index.html|DedeCMS(织梦)|dedecms',
'/admin/js/validator.js|ecshop|ECSHOP',
'/templates/atomic/css/template.css|Joomla(逐浪)|joomla',
'/License.txt|KingCMS|kingcms',
'/index.html|phpCMS(盛大)|phpcms',
'/zb_users/THEME/default/theme.xml|Z-Blog|z-blog',
'/block/core.class.php|KingCMS|kingcms',
'/install.sql|KingCMS|kingcms',
'/images/admincp/admincp.js|Discuz(康盛)|discuz',
'/|dayrui系列CMS|dr_ci_session',
'/|DotNetNuke|DotNetNukeAnonymous',
'/collect.asp|KingCMS|kingcms',
'/install/templates/license_en_us.htm|Ecshop(商派)|ecshop',
'/web.config.txt|Joomla(逐浪)|joomla',
'/FS_InterFace/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/|大米CMS|content="damicms',
'/gbook/_notes/dwsync.xml|aspcms|AspCms',
'/Qq/xml/qq.xml|Southidc(南方数据)|southidc',
'/link.asp|KingCMS|kingcms',
'/install/|ecshop|ecshop',
'/collect/index.asp|KingCMS|kingcms',
'/wp-content/themes/classic/rtl.css|WordPress|wordpress',
'/robots.txt|PHPWind|phpwind',
'/stat/uninstall/mysql.sql|phpCMS(盛大)|phpcms',
'/demo/zh_cn.sql|Ecshop(商派)|ecshop',
'/conf/md5sum|PHPWind|phpwind',
'/Css/yellow/style.css|Dvbbs(动网)|dvbbs',
'/page/system/inc/fun.js|KingCMS|kingcms',
'/LiveServer/Inc/html_head.inc|SiteServer|siteserver',
'/|Jspxcms|/template/1/bluewise/_files/jspxcms.css',
'/misc/ajax.js|Drupal(水滴)|drupal',
'/js/jqeditor/hdwiki.js|HdWiki(中文维基)|hdwiki',
'/install/|AspCMS|aspcms',
'/editor/js/editor.js|phpCMS(盛大)|phpcms',
'/installation/language/en-US/en-US.ini|Joomla(逐浪)|joomla',
'/js/hdeditor/skins/content.css|HdWiki(中文维基)|hdwiki',
'/js/hdeditor/hdeditor.min.js|HdWiki(中文维基)|hdwiki',
'/plugins/ucenter/view/admin_ucenter.htm|HdWiki(中文维基)|hdwiki',
'/content/templates/default/tpl.ini|Emlog|emlog',
'/d/txt/index.html|EmpireCMS(帝国)|empirecms',
'/FS_Inc/vssver2.scc|FoosunCMS(风讯)|foosuncms',
'/e/admin/user/data/certpage.txt|EmpireCMS(帝国)|empirecms',
'/e/data/html/cjhtml.txt|EmpireCMS(帝国)|empirecms',
'/Admin/Images/southidc.css|Southidc|southidc',
'/statics/js/cookie.js|phpcms|phpcms',
'/e/install/data/empirecms.com.sql|EmpireCMS(帝国)|empirecms',
'/zb_users/THEME/metro/TEMPLATE/footer.html|Z-Blog|z-blog',
'/themes/default/style.css|Ecshop(商派)|ecshop',
'/core/CHANGELOG.txt|Drupal(水滴)|drupal',
'/onepage/index.asp|KingCMS|kingcms',
'/ashx/comment.ashx|LjCMS(良精)|ljcms',
'/e/tasks/index.html|EmpireCMS(帝国)|empirecms',
'/readme.html|WordPress|WordPress',
'/adminsoft/control/sqlmanage.php|EspCMS(易思)|espcms',
'/install/|PHP168(国徽)|php168',
'/templates/wap/cn/public/footer.html|EspCMS(易思)|espcms',
'/API/Request.xml|PowerEasy|powereasy',
'/include/javascript/ajax.js|Discuz(康盛)|discuz',
'/Editor/plugins/pastefromword/dialogs/pastefromword.js|PowerEasy(动易)|powereasy',
'/u2upopup.js|Discuz(康盛)|discuz',
'/Images/ad.js|Southidc(南方数据)|southidc',
'/modules/mod_banners/mod_banners.xml|Joomla(逐浪)|joomla',
'/search/index.html|EmpireCMS(帝国)|empirecms',
...
'/bill/install/mysql.sql|phpCMS(盛大)|phpcms',
'/data/js/config.js|phpCMS(盛大)|phpcms',
'/data/lang/zh_cn.js|PHPWind|phpwind',
'/plus/sitemap.html|DedeCMS(织梦)|dedecms',
'/hack/cnzz/template/menu.htm|PHP168|php168',
'/README.txt|Drupal(水滴)|drupal',
'/admin/template/sort/editsort.htm|qibosoft|qiboSoft',
'demo/js/check.js|ecshop|ecshop',
'/template/special/showsp2.htm|qibosoft|qiboSoft',
'/images/js/admin.js|phpCMS(盛大)|phpcms',
'/|SiteServer|siteserver',
'/page/aboutus.html|phpCMS(盛大)|phpcms',
'/boke/Skins/Default/xml/index.xslt|Dvbbs(动网)|dvbbs',
'/sites/all/modules/README.txt|Drupal(水滴)|drupal',
'/mspace/default/style.ini|Discuz(康盛)|discuz',
...
'/install/|PHP168|php168',
'/admin/inc/admin.js|Dvbbs(动网)|dvbbs',
'/|IMGCms|content="IMGCMS',
'/images/dialog.css|PHP168|php168',
'/admin/template/label/article.htm|qiboSoft(齐博)|qiboSoft',
'/boke/CacheFile/System.config|Dvbbs(动网)|dvbbs',
'/install/sys_inc.php|EspCMS(易思)|espcms',
'/inc/config.asp|KingCMS|kingcms',
'/installation/CHANGELOG|Joomla(逐浪)|joomla',
'/dede/templets/article_coonepage_rule.htm|DedeCMS(织梦)|dedecms',
'/js/util.js|PHP168(国徽)|php168',
...
'/member/template/default/homepage.htm|qibosoft|qiboSoft',
...
'/formguide/install/templates/form_index.html|phpCMS(盛大)|phpcms',
'/template/default/common/common.css|Discuz|Discuz',
'/admin/SouthidcEditor/Include/Editor.js|Southidc(南方数据)|southidc',
'/wp-includes/wlwmanifest.xml|WordPress|wordpress',
'/|BitrixSiteManager|X-Powered-CMS:Bitrix Site Manager',
'/e/tool/feedback/temp/test.txt|EmpireCMS(帝国)|empirecms',
'/passport/index.asp|KingCMS|kingcms',
'/templates/atomic/css/template.css|joomla|joomla',
'/En/Foot.Asp|liangjing(良精)|liangjing',
'/webftp.asp|KingCMS|kingcms',
'/admin/template/blend/set.htm|qibosoft|qiboSoft',
'/language/en-GB/en-GB.com_contact.ini|Joomla(逐浪)|joomla',
'/gbook/_notes/dwsync.xml|AspCMS|aspcms',
'/inc/_notes/dwsync.xml|AspCMS|aspcms',
'/admin/template/label/maketpl/1.htm|qiboSoft(齐博)|qiboSoft',
'/components/com_wrapper/wrapper.xml|Joomla(逐浪)|joomla',
'/robots.txt|Discuz|Discuz',
'/installation/language/en-US/en-US.ini|joomla|joomla',
...
'/install/|Ecshop(商派)|ecshop',
'/template/admin/ask/config.html|PHP168(国徽)|php168',
'/announce/install/templates/index.html|phpCMS(盛大)|phpcms',
'/modules/legacy/legacy.info|Drupal(水滴)|drupal',
'/Admin/MasterPage.master|PowerEasy(动易)|powereasy',
'/|WebsiteBaker CMS|wb_session_id',
'/Admin/JS/AdminIndex.js|PowerEasy|powereasy',
'/Apsearch.html|FoosunCMS(风讯)|foosuncms',
'/plugins/authentication/joomla/joomla.xml|joomla|joomla',
'/windid/res/js/dev/wind.js|PHPWind|phpwind',
'/media/com_finder/js/indexer.js|Joomla(逐浪)|joomla',
'/Skin/OceanStar/user/default.css|PowerEasy|powereasy',
'/e/data/html/cjhtml.txt|empirecms|empirecms',
'/.htaccess|Drupal(水滴)|drupal',
'/style/default/desc.xml|HdWiki|hdwiki',
'/uc_server/view/default/admin_frame_main.htm|Discuz|Discuz',
'/User/PopCalendar.js|PowerEasy|powereasy',
'/INSTALL.sqlite.txt|Drupal(水滴)|drupal',
'/e/data/tmp/cj/index.html|EmpireCMS(帝国)|empirecms',
'/member/include/js/login.js|phpCMS|phpcms',
'/dede/css_body.css|DedeCMS(织梦)|dedecms',
'/spider/uninstall/mysql.sql|phpCMS(盛大)|phpcms',
'/html/index.html|EmpireCMS(帝国)|empirecms',
'/language/zh-cn.xml|KingCMS|kingcms',
'/INSTALL.txt|Drupal(水滴)|drupal',
'/media/com_joomlaupdate/default.js|joomla|joomla',
'/page/addlink.asp|KingCMS|kingcms',
'/Install/SQL/Value/site_param.sql|FoosunCMS(风讯)|foosuncms',
'/e/tasks/index.html|empirecms|empirecms',
'/js/jqeditor/skins/content_default.css|HdWiki(中文维基)|hdwiki',
'/license.txt|WordPress|WordPress',
'/template/config/admin/config_run.htm|PHPWind|phpwind',
'/themes/default_old/activity.dwt|Ecshop(商派)|ecshop',
'/install/lan_inc.php|EspCMS(易思)|espcms',
'/js/editor/editor.js|HdWiki|hdwiki',
    ...
    for xxx in result_list:
        if 'www.' in xxx:
            try:
                ...
                unicode('    网址友链采集:      ', 'utf-8')) + r.url + '      ' + str(
                    r.status_code)
...
def scan_cms(url):
    ...
    # 网页中和请求头中关键词判断
    # key 对应关键词 ，value 对应 cms类型
    try:
        req3 = requests.get(url=url, headers=headers, allow_redirects=False, timeout=3)
        print (
            str(threading.current_thread().name) + unicode('    CMS类型识别:    ',
                                                           'utf-8') + '  ' + req3.url + '    ' + str(
                req3.status_code))
        ...
        for s in st:
            ...
            try:
                ...
                if req1.status_code == 200:
                    ...
                    didx = int(
                        str(difflib.SequenceMatcher(None, rrsa, req1_2.content).quick_ratio() * 10000).split('.')[0])

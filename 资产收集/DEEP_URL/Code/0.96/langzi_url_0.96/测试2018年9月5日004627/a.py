            ...
            if track == 0:
                if urls != 'None' or black_urls != 'None':
                    if titles == 'None' and black_titles == 'None' and contents == 'None' and black_contents == 'None':
                        try:
                            ...
                            # #pool.apply_async(get_url,bbaidu)
                            # pool.close()
                            # pool.join()
                            for x in bbaidu:
                                get_url(x)
                ...
                if titles != 'None' or black_titles != 'None' or contents != 'None' or black_contents != 'None':
                        try:
                            ...
                            #pool.apply_async(get_info, bbaidu)
                            pool.close()
                            pool.join()
                        except Exception, e:
                            log((' [*] 异常状态 : ' + str(e)).decode('gbk'))
            ...
            if track == 1:
                ...
                if forever == 1:
                    ...
                    try:
                        ...
                        #pool.apply_async(wuxiancaiji,bbaidu)
                        pool.close()
                        pool.join()
                    except Exception,e:
                        log((' [*] 异常状态 : ' + str(e)).decode('gbk'))
                    ...
                    for _ in range(forever-1):
                        try:
                            ...
                            try:
                                ...
                                #pool.apply_async(wuxiancaiji, f)
                                pool.close()
                                pool.join()
                            except Exception, e:
                                log((' [*] 异常状态 : ' + str(e)).decode('gbk'))
                ...
                if track == 0:
                    ...
                    if titles != 'None' or black_titles != 'None' or contents != 'None' or black_contents != 'None':
                        try:
                            ...
                            #pool.apply_async(get_info, urllist)
                            pool.close()
                            pool.join()
                        except Exception, e:
                            log((' [*] 异常状态 : ' + str(e)).decode('gbk'))
